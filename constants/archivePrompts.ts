...
\${rawLog}`
    ...
    {
        id: 'preset_with_calls',
        name: '日记+电话 (Diary + Calls)',
        content: `当前日期: \${dateStr}
任务: 请回顾今天的聊天记录，将其转化为一条**属于你自己的**"核心记忆"。
...
5.  **电话记录 (Phone Calls)**:
    - 聊天记录中被 [电话记录] 和 [通话结束] 包裹的内容，是我们**打电话时说的话**。
    - 电话里聊的内容和文字聊天同等重要，甚至更真实——因为打电话时人更放松、更容易流露真实情绪。
    - 不要忽略电话里聊过的任何重要话题。如果电话里发生了有趣的事或情绪变化，一定要记下来。
