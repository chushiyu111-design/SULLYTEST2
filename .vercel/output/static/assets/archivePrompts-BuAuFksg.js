const e=[{id:"refine_atmosphere",name:"氛围月记 (Atmosphere)",content:`### [角色月度记忆精炼]
当前月份: \${dateStr}
身份: 你就是 \${char.name}
...
### 本月记忆碎片
\${rawLog}`},{id:"refine_keypoints",name:"要点速记 (Key Points)",content:`### [月度记忆压缩]
月份: \${dateStr}
角色: \${char.name}
...
### 记忆输入
\${rawLog}`}],a=[{id:"preset_rational",name:"理性精炼 (Rational)",content:`### [System Instruction: Memory Archival]
当前日期: \${dateStr}
...
### 待处理的聊天日志 (Chat Logs)
\${rawLog}`},{id:"preset_diary",name:"日记风格 (Diary)",content:`当前日期: \${dateStr}
...
### 待处理的聊天日志 (Chat Logs)
\${rawLog}`},{id:"preset_with_calls",name:"日记+电话 (Diary + Calls)",content:`当前日期: \${dateStr}
任务: 请回顾今天的聊天记录，将其转化为一条**属于你自己的**"核心记忆"。
